...
// TenantV1alpha1Client is used to interact with features provided by the tenant.kubezoo.io group.
...
// NewForConfigAndClient creates a new TenantV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TenantV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := tenantv1alpha1.SchemeGroupVersion
